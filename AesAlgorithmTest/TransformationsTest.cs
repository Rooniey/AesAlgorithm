...
namespace AesAlgorithmTest
{
    ...
    public class TransformationsTest
    {
        ...
        private Mock<IRoundKeyProvider> _keyProvider;

        [TestInitialize]
        public void SetUp()
        {
            _keyProvider = new Mock<IRoundKeyProvider>();
            _keyProvider.Setup(foo => foo.GetKey(0)).Returns(new byte[,]
            {
                {0xa0, 0x88, 0x23, 0x2a},
                {0xfa, 0x54, 0xa3, 0x6c},
                {0xfe, 0x2c, 0x39, 0x76},
            ...
            _aesAlgorithmImp = new AesAlgorithmImp(_keyProvider.Object);
        }
